...
./aviation_GLYPHS 100000 proton 58168090.0

# Copy results to safe folder
cp /projects/jucl6426/Aviation_GLYPHS/build/results/mlat_45deg_input_450km/proton_input_58168090.0keV_100000particles_*_spectra.csv /projects/jucl6426/Aviation_GLYPHS/results
