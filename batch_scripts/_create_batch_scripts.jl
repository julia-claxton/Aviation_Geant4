...
results_dir = "/Users/luna/Research/geant4/Aviation_GLYPHS/_isotropic_beams"
existing_particles, existing_energies = get_beams(results_dir, input_particle = "alpha")
...
energies = [proton_energies..., alpha_energies...]
particles = [repeat(["proton"], length(proton_energies))..., repeat(["alpha"], length(alpha_energies))...]
