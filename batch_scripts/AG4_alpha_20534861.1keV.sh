...
./aviation_GLYPHS 100000 alpha 20534861.1

# Copy results to safe folder
cp /projects/jucl6426/Aviation_GLYPHS/build/results/mlat_45deg_input_450km/alpha_input_20534861.1keV_100000particles_*_spectra.csv /projects/jucl6426/Aviation_GLYPHS/results
